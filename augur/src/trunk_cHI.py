...
############################################
flist = ['H9_1985to2016_cHI_path.pkl', 'H1N1pdm_7y_cHI_path.pkl',
        'Yam_20y_cHI_path.pkl', 'Vic_20y_cHI_path.pkl' ]

plt.figure(figsize=(2*figheight, figheight))
ax=plt.subplot(121)
cols = {flu:col for flu, col in zip(['H9', 'H1N1pdm', 'Yam', 'Vic'], sns.color_palette(n_colors=4))}
